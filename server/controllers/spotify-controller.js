...
; // Your client id
const client_secret = process.env.spotifyClientSecret || nconf.get('server:api:spotify:clientSecret') // Your secret
const redirect_uri = 'http://localhost:3001/spotify/callback'; // Your redirect uri
